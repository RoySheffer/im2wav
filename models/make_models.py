...
from models.hparams import Hyperparams, setup_hparams, REMOTE_PREFIX, small_vqvae, DEFAULTS
from models.utils.remote_utils import download
from models.utils.torch_utils import freeze_model
...
MODELS = {
    'im2wav': ("small_multi_level_vqvae", "small_upsampler", "small_labelled_prior")
}
...
def make_prior(hps, vqvae, device='cuda'):
    ...
    prior = SimplePrior(z_shapes=z_shapes,
                        ...
                        clip_emb=hps.clip_emb,
                        video_clip_emb=hps.video_clip_emb)
    ...
    if hps.fp16_params:
        ...
        from models.transformer.ops import _convert_conv_weights_to_fp16
