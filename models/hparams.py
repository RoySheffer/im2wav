...
easy = Hyperparams(sr=22050,)
HPARAMS_REGISTRY["easy"] = easy

REMOTE_PREFIX = 'https://openaipublic.azureedge.net/'
CLIP_VERSION = "ViT-B/32"
PASST_SAMPLERATE = 32000
SAMPLE_RATE = 16000
VIDEO_TOTAL_LENGTHS = 160000
VIDEO_FPS = 30
EPS = 1e-5
WAV2CLIP_SAMPLERATE =16000
...
small_multi_level_vqvae = Hyperparams(
    sr = 16000,
    levels = 2,
    downs_t = (3, 2),
    strides_t = (2, 2),
...
HPARAMS_REGISTRY["small_multi_level_vqvae"] = small_multi_level_vqvae

hq_small_multi_level_vqvae = Hyperparams(
    sr = 16000,
    levels = 2,
    downs_t = (2, 2),
    strides_t = (2, 2),
...
HPARAMS_REGISTRY["hq_small_multi_level_vqvae"] = hq_small_multi_level_vqvae

triple_vqvae = Hyperparams(
    sr = 16000,
    levels = 3,
    downs_t = (1, 2, 1),
    strides_t = (2, 2, 2),
...
HPARAMS_REGISTRY["triple_vqvae"] = triple_vqvae
...
HPARAMS_REGISTRY["mid_prior"] = mid_prior
...
mid_labelled_prior = Hyperparams(
    labels=True,
    labels_v3=True,
    y_bins=(10,100), # Set this to (genres, artists) for your dataset
    max_bow_genre_size=1,
...
mid_labelled_prior.update(mid_prior)
HPARAMS_REGISTRY["mid_labelled_prior"] = mid_labelled_prior

small_upsampler = Hyperparams(
    n_ctx=4096, # n_ctx = sample_length / downsample_of_level
    prior_width=1024,
    prior_depth=48,
    heads=1,
    c_res=1,
...
DEFAULTS["data"] = Hyperparams(
    ...
    file2CLIP="",
    clip_emb=False,
    video_clip_emb=False,
    class_free_guidance_prob=-1,
)
