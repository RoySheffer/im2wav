...
def load_audio(file, sr, offset, duration=None, resample=True, approx=False, time_base='samples', check_duration=True):
...
def test_dataset_loader():
    ...
    from models.data.files_dataset import FilesAudioDataset
